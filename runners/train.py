...
def model_trainer(cl_vars):
    ...
    if cl_vars['lr_find'] or conf['run_type']['training_mode']=='lr_find':
        ...
        trainer = Trainer(
                        ...
                        strategy=conf['compute_parameters'].get('strategy', None),
                        devices=[int(g) for g in conf['compute_parameters']['gpus']] if isinstance(conf['compute_parameters']['gpus'], (list, tuple)) else int(conf['compute_parameters']['gpus']),
                        auto_select_gpus=conf['compute_parameters']['auto_select_gpus'],
